...
if [ "$1" == "16S" ]; then
    picrust2_pipeline.py -s output/study_seqs_16S.fna -i output/output_file.biom -o output/picrust_$1 -p 12
elif [ "$1" == "ITS" ]; then
    picrust2_pipeline.py -s output/study_seqs_ITS.fna -i output/output_file.biom -o output/picrust_$1 -p 12 \
